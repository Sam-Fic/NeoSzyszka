## Fork (Sam-Fic)
Rewrite of the UI with **GTK 4 and libadwaita** (GNOME HIG compliant). Fork maintained by Sam-Fic — <https://github.com/Sam-Fic/NeoSzyszka>. Based on Szyszka by Rafał Mikrut (<https://github.com/qarmin/szyszka>).
